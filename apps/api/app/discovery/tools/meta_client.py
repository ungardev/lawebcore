...
class MetaClient:
    ...
    async def discover_pages(
        ...
        """Discover Facebook Pages by niche categories + country.

        Uses Facebook Graph API search to find pages related to niche keywords.
        Returns pages with Instagram links if available.
        """
        client = await self._get_client()
    ...
    def _build_search_queries(self, niches: list[str], country: str) -> list[str]:
        """Build search queries from niches and country."""
        queries = []

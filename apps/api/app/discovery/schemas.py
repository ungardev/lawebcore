"""Pydantic schemas para el módulo de Discovery."""
...
class CandidateMetrics(BaseModel):
    """Métricas de un candidato scraped."""
...
class MatchScoreResult(BaseModel):
    ...
    match_score: float = Field(ge=0, le=100, description="Score global 0-100")
...
class CandidateWithScore(BaseModel):
    """Candidato enriquecido con score de matching."""
...
class MessageCreate(BaseModel):
    """Request para enviar mensaje en conversación."""

    content: str


class MessageResponse(BaseModel):
    """Response de un mensaje IA."""
...
class DiscoverySearchRequest(BaseModel):
    """Request para búsqueda directa sin chat."""
...
class DiscoveryRunResponse(BaseModel):
    """Response de un run de búsqueda."""

...
> **Hito actual:** Hito 36 completo ✅ · M3-Agente A/B/C ✅ · Funnel Invariant fix ✅ · Fable 5 P0-1..P0-4 ✅ · `644c513` B1/B2/B3 ✅ · `7ce50da` credentials ✅ · N-1..N-4 OpenAPI spec ✅ · **B-FE-7/B-FE-15 FIXED (paridad de estados FE↔BE + wizard de un click)** ✅ · **E2E ❌ PENDIENTE (UI o script)**
> **HikerAPI balance:** ~$35 USD restantes · Pre-flight FUNCIONAL (`/sys/balance`)
> **E2E Test:** ❌ FALLÓ run `10a59ecf` — 188 handles → 0 candidatos · Todos los fixes aplicados (backend N-1..N-4 + frontend B-FE-7/15) · E2E pendiente
> **NUEVO (04-sep, tarde):** `docs/FIXES_FRONTEND_STATUS_PARITY_BFE7_04-09-26.md` · useRunPolling detenía polling solo en estados legacy (completed/partial) que el backend jamás emite → un run exitoso (`delivered`) giraba infinito y NUNCA mostraba candidatos · Wizard ahora auto-confirma (un click) · TikTok/YouTube deshabilitados con "Próximamente" (pipeline IG-only) · Test de contrato FE↔BE en CI · 197 passed, tsc + eslint limpios

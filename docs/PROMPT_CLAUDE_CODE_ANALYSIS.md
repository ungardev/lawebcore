...
> **NUEVO (04-sep, noche):** `docs/FIXES_BRIEF_FIELDS_LEAK_04-09-26.md` — fuga cerrada: `additional_context`/`competitor_brands`/`influencer_preferences` se perdían al crear el run (100%) → +12 campos al schema + pasados en discovery.py + roundtrip tests · Wizard dice la verdad (nichos = contexto IA) · Decisión: NO reordenar nichos/keywords hasta E2E baseline

...
> **NUEVO (05-sep):** `docs/FIXES_RAILWAY_WORKER_RESILIENCE_05-09-26.md` — worker arq muerto por blip de Redis (supervisor con backoff agregado) · cron 09:00 diario (coerción PostgREST true/false) · bug latente `col=in.(...)` con "=" → 0 filas en modo Analizar (expandido a IN) · E2E UI desbloqueado tras deploy

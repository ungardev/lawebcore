...
> **NUEVO (04-sep, noche):** `docs/FIXES_DEEPSEEK_RAG_04-09-26.md` — brief_parser dejaba briefs en silencio degradados (max_tokens=300), RAG era mono-turno (historial tirado a la basura), cliente LLM sin cache de conexiones, retries sobre 4xx, analyzer con prompt/json_object incompatibles, dead code con thinking ON eliminado, vectores cero en pgvector eliminados

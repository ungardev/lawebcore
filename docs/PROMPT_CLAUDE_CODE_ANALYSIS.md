...
> **NUEVO (07-sep, E2E real):** Primer E2E vía UI ejecutado — TODO funcionó (worker, pre-flight, discovery 168 handles, enrichment 25, medias/ER real, chat progress) excepto 1 crash de scoring: `drop_profile` con `detail={'reason'}` → TypeError (8 call sites afectados). FIXED con guard central + renombres + dedupe geo. Ver `docs/FIXES_SCORING_CRASH_E2E_07-09-26.md`
